...
public class PodeliSporedProsek {
    ...
    public static void podeli(SLL<Integer> lista) {
        ...
        //my code
        float average = 0;
        SLLNode<Integer> listaIterator = lista.getFirst();
        while (listaIterator != null)
        {
            average+=listaIterator.element;
            listaIterator = listaIterator.succ;
//            System.out.println("Average = " + average);
        }
        average/=lista.length();
//        System.out.println("Total Average = " + average);
        listaIterator = lista.getFirst();
        while(listaIterator != null)
        {
            if(listaIterator.element <= average)
            {
                pomali.insertLast(listaIterator.element);
            }
            else
            {
                pogolemi.insertLast(listaIterator.element);
            }
            listaIterator = listaIterator.succ;
        }
